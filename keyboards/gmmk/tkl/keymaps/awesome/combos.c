...
// const uint16_t PROGMEM l_1_2u_shift[] = {KC_, KC_, COMBO_END};
// const uint16_t PROGMEM r_1_2u_shift[] = {KC_, KC_, COMBO_END};
// const uint16_t PROGMEM l_1_3h_alt[] = {KC_, KC_, COMBO_END};
// const uint16_t PROGMEM r_1_3h_alt[] = {KC_, KC_, COMBO_END};
// const uint16_t PROGMEM l_1_3u_win[] = {KC_, KC_, COMBO_END};
// const uint16_t PROGMEM r_1_3u_win[] = {KC_, KC_, COMBO_END};
// const uint16_t PROGMEM l_2h_3h_ctrl_shift[] = {KC_, KC_, COMBO_END};
// const uint16_t PROGMEM r_2h_3h_ctrl_shift[] = {KC_, KC_, COMBO_END};
...
combo_t key_combos[] = {
    ...
    // [L_1_2U_SHIFT] = COMBO(l_1_2u_shift, KC_),
    // [R_1_2U_SHIFT] = COMBO(r_1_2u_shift, KC_),
    // [L_1_3H_ALT] = COMBO(l_1_3h_alt, KC_),
    // [R_1_3H_ALT] = COMBO(r_1_3h_alt, KC_),
    // [L_1_3U_WIN] = COMBO(l_1_3u_win, KC_),
    // [R_1_3U_WIN] = COMBO(r_1_3u_win, KC_),
